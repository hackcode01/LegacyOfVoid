#include "../../../Include/Core/Errors/Errors.hpp"

std::array<const char *, (size_t)Errors::ERROR_MAX> errorNames{
    "OK",                            // OK
    "Failed",                        // FAILED
...
static_assert(std::size(errorNames) == (size_t)Errors::ERROR_MAX);
